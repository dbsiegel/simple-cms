...
module PositionMover
  ...
  def move_to_position(new_position)
    ...
    unless new_position.nil?
      new_position = [[1, new_position.to_i].max, max_position].min #force value to be between 1-max. 1 or new position, take maxiumum value of that, then take that result and put in array with max position, and take the lower value of them
    end
